...
def read_csv_file(filepath):
    ...
    with open(filepath, "r", encoding="utf-8") as csvfile:
        try:
            ...
            # check how many rows because there were problems with fields with newlines in them for multiple attachments
            ...
            for line in lines: 
                    ...
                    for item in line:
                       ...
                       # might need to remove this step if they are needed later on
